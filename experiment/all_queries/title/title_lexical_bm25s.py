...
index_path = "./experiment/all_queries/output/cache/lexical_bm25s.title"
result_path = "./experiment/all_queries/output/result/lexical_bm25s.title.json"
result_label_path = "./experiment/all_queries/output/result/lexical_bm25s.title.label.json"
