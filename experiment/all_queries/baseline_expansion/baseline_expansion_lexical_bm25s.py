...
index_path = f"./experiment/all_queries/output/cache/lexical_bm25s.{expansion_file}"
result_path = f"./experiment/all_queries/output/result/lexical_bm25s.{expansion_file}.json"
result_label_path = f"./experiment/all_queries/output/result/lexical_bm25s.{expansion_file}.label.json"
