...
# config
index_path = f"./experiment/all_queries/output/cache/semantic_transformers.index"
query_path = f"./experiment/all_queries/output/cache/semantic_transformers.query"
result_path = f"./experiment/all_queries/output/result/semantic_transformers.json"
result_label_path = f"./experiment/all_queries/output/result/semantic_transformers.label.json"
